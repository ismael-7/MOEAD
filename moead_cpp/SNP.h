...
double logistic_score(int* selectedSNPSet, int k, SNP SNPdata, double *time,std::fstream &fout); // Calcula el valor de la función objetivo de la verosimilitud de un conjunto de SNPs dado (selectedSNPSet). k es el tamaño de la epistasia y SNPData los datos de la instancia
